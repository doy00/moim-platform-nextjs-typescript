  ...
  return (
    <div className="flex flex-col space-y-4 px-5 min-h-[680px]">
      ...
      <div>
        ...
        <div className="relative w-[120px] h-[120px] md:w-[240px] md:h-[240px] mt-2 bg-background400 rounded-md flex items-center justify-center transition-all duration-300">
          {image ? (
