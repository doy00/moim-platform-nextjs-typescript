    ...
    <div className="flex flex-col space-y-6 px-5 h-[680px]">
      ...
      <div>
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <button onClick={handleDecrementMin} className="min-w-[72px] h-16 bg-background400 rounded-xl">
            <MinusIcon className="fill-gray300" />
          </button>
          <button onClick={handleIncrementMin} className="min-w-[72px] h-16 bg-background400 rounded-xl">
      ...
      <div>
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            className="flex-1 min-w-[183px] h-16 p-4 bg-background400 rounded-xl"
          />
          <button onClick={handleDecrementMax} className="min-w-[72px] h-16 bg-background400 rounded-xl">
            <MinusIcon className="fill-gray300" />
          </button>
          <button onClick={handleIncrementMax} className="min-w-[72px] h-16 bg-background400 rounded-xl">
            <PlusLineIcon className="fill-gray300" />
          </button>
        </div>
      </div>
